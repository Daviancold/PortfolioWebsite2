...
images:
  - "/images/projects/project-01/peerprep-01.jpg"
  - "/images/projects/project-01/peerprep-02.jpg"
  - "/images/projects/project-01/peerprep-03.jpg"
  - "/images/projects/project-01/peerprep-04.jpg"
team:
  - name: "Davian Kho"
...
- **User Matchmaking**: Developed a custom Figma plugin that extracts design tokens such as colors, typography, and spacing values, and exports them in a format compatible with our codebase.
- **Live Collaboration and Chatroom**: Integrated an automated process that translates Figma components into React code using a combination of design tokens and pre-built component templates. This allowed developers to focus more on logic and less on repetitive UI coding.
